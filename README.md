...
Download
Download the latest EDF6VR ZIP under Assets on the Releases page (not the automatically generated source code archives).
...
Installation
Extract everything in the ZIP into the game folder, next to EDF6.exe (for example \Steam\steamapps\common\EARTH DEFENSE FORCE 6).
Run VR_Play.bat: Y = VR, N = normal flat play. Close the game before switching.
